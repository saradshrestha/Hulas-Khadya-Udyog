...
@section('pageTitle', 'Career Us | ' . getSiteSetting('site_title'))
@push('styles')
    <style>
...
{{-- @section('banner')
    @include('front.contact.contactbanner')
@endsection --}}
    ...
    <section class="contact-sc pb-3" id="contact-sc">
        <div class="container px-0 position-relative">
            <div class="contact-info-itms gy-4 justify-content-center">
                ...
                <div class="contact-info-itm">
                    <div class="contact-info-itm-icon">
                        <img src="{{ asset('frontendFiles/assets/images/pg-contact/phone-icon.svg') }}" alt=""
                            style="width:50px;">
                    </div>
            ...
            <div class="row contact-form">
                <div class="contact-form-title">
                    <h3 class="fw-4 fs-32">Career form</h3>
                </div>
                <form method="POST" action="{{ route('submitCareer') }}">
                    @csrf
                    <div class="row contact-form-grid">
                        <div class="contact-form-l col-lg-6">
                            <div class="form-elem">
                                ...
                                <div class="input-group">
                                    <div class="input-group-text bg-transparent border-0">
                                        <img src="{{ asset('frontendFiles/assets/images/pg-contact/profile-o-icon.svg') }}"
                                            alt="">
                                    </div>
                            ...
                            <div class="form-elem">
                                ...
                                <div class="input-group">
                                    <div class="input-group-text bg-transparent border-0">
                                        <img src="{{ asset('frontendFiles/assets/images/pg-contact/sms-o-icon.svg') }}"
                                            alt="">
                                    </div>
                            ...
                            <div class="form-elem">
                                ...
                                <div class="input-group">
                                    <div class="input-group-text bg-transparent border-0">
                                        <img src="{{ asset('frontendFiles/assets/images/pg-contact/call-o-icon.svg') }}"
                                            alt="">
                            ...
                            <div class="form-elem">
                                <label for="" class="form-label fs-22">Upload CV</label>
                                <div class="input-group">
                                    <div class="input-group-text bg-transparent border-0">
                                        <img src="{{ asset('frontendFiles/assets/images/pg-contact/call-o-icon.svg') }}"
                                            alt="">
                                    ...
                                    <input type="file" name="upload_file" accept="application/pdf" class="form-control bg-transparent border-0">
                                    @error('upload_file')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
