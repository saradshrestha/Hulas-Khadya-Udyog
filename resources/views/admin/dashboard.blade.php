...
<div class="layout-px-spacing">
    <div class="row mt-2">
        <div id="card_1" class="col-md-12">
            <div class="statbox widget box box-shadow"> <div class="row ">
                <div class="col-xl-6 col-md-6 col-sm-6 col-12">
                    <h4>Welcome To Admin Dashboard</h4>
                </div>
            </div>
            <div class="card component-card_1 mt-2"  style="border-radius:10px;">
                <div class="card-body">
                    <div class="table-responsive">
                        <div class="d-flex mt-2" style="justify-content : space-between;">
                        <h5 class="mb-3">Latest 10 Products</h5>
                        <a href="{{ route('admin.product.allProducts') }}" class="btn btn-primary mb-2 "> View All Products </a>
                        </div>
                        <table class="table mb-4">
                            <thead>
                                <tr>
                                    ...
                                    <th>Status</th>
                                    {{-- <th class="text-center">Featured Product</th>    --}}
                                </tr>
                            </thead>
                            <tbody>
                                @if (count($allproducts) > 0 && isset($allproducts))      
                                    @foreach ($allproducts as $product)
                                        <tr>
                                            <td class="text-primary" width=40%>{{ $product->title }}</td>
                                            <td width=20% class="text-center">
                                                <img src="{{ asset($product->feature_url['thumbnail_image']) ?? asset("image/brand/1627543481samsung-galaxy-s8.png") }}" style="height: 100px" width="100px" alt="">
                                            </td>
                                            ...
                                            {{-- <td  width=10% class="text-center">
                                                <span class="badge {{ $product->is_featured=="Yes" ? 'badge-success' : 'badge-danger' }}">{{$product->is_featured}}</span>
