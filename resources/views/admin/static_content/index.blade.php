    ...
    <div class="layout-px-spacing">
        ...
        <div class="row layout-top-spacing">
            <div id="breadcrumbArrowed" class="col-xl-12 col-lg-12 layout-top-spacing mb-3">
                @include('admin.partials.breadcrumbs', ['type'=>'index', 'label'=>'Static Content', 'route'=>'static.content'])
            </div>
                        ...
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            ...
                            @foreach($blogs as $blog)
                                <tr>
                                    ...
                                    <td>{{ $blog->title }} </td>
                                    <td>{{ $blog->slug }} </td>
                                    <td> @if($blog->status == 'Active') <span class="badge badge-success">Active</span> @else <span class="badge badge-danger">Inactive</span> @endif</td>
                                    <td>
                                        <a href="{{ route('admin.static.content.edit', $blog->slug) }}" title="Edit" class="badge badge-success"> <i data-feather="edit"></i></a>
                                        <a href="{{ route('admin.static.content.delete', $blog->slug) }}" title="Delete" class="badge badge-dark warning confirm"><i data-feather="archive"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
