...
@section('contents')
    ...
    <div class="layout-px-spacing">
        <div class="row">
            <div id="breadcrumbArrowed" class="col-xl-12 col-lg-12 layout-top-spacing mb-2">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>Career Messages</h4>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-6">
                                <nav class="breadcrumb-two" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a href="{{ route('admin.career') }}">Careers</a></li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <table id="datatable" class="table table-hover" style="width:100%">
                            ...
                            @foreach($careers as $career)
                                <tr>
                                    ...
                                    <td>{{ $career->name }} </td>
                                    <td>{{ $career->email }}<a class="badge badge-success ml-4" href="mailto:{{ $career->email }}">Send Mail</a> </td>
                                    <td >
                                        {{ $career->phone ?? 'N/A' }}
                                    </td>
                                    {{-- <td>{{ $career->subject }}</td> --}}
                                    <td>@if($career->seen == 1) <span class="badge badge-success">Seen</span> @else <span class="badge badge-danger">Unseen</span> @endif</td>
                                    <td>

                                        <a href="{{ route('admin.career.show', $career->id) }}" title="Edit" class="badge badge-primary viewPopUpModal"> <i data-feather="eye"></i></a>
                                        <a href="{{ route('admin.career.delete', $career->id) }}" title="Delete" class="badge badge-dark warning confirm"><i data-feather="archive"></i></a>
