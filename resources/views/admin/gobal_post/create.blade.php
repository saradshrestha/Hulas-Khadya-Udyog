...
@section('title','Add '.$postType->title)
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-12 mx-auto">
                            <form method="post" enctype="multipart/form-data"
                                action="{{ route('admin.post.store', $postType->slug) }}">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input id="post_title" value="{{ old('title') }}" type="text"
                                                name="title" placeholder="{{ $postType->title }} Title..."
                                                class="form-control main-label" required>
                                        </div>
                                        @if ($postType->has_sub_title == 1)
                                            <div class="form-group">
                                                <p>Sub Title</p>
                                                <label for="t-text" class="sr-only">{{ $postType->title }} Sub Title</label>
                                                <input id="post_sub_title" value="{{ old('sub_title') }}" type="text"
                                                    name="sub_title" placeholder="{{ $postType->sub_title }} Sub Title..."
                                                    class="form-control">
                                            </div>
                                        @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input id="slug" value="{{ old('slug') }}" type="text"
                                                    name="slug" placeholder="{{ $postType->title }} Slug..."
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="alt_txt" value="{{ old('img_alt') }}" type="text"
                                                    name="img_alt" placeholder="Image Alt Text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="img_title" value="{{ old('img_title') }}" type="text"
                                                    name="img_title" placeholder="Image Title" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="meta_title" value="{{ old('meta_title') }}" type="text"
